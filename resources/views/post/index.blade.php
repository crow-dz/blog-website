                                ...
                                <div class="article-meta flex py-1 text-sm items-center">
                                    @if ($post->author->profile_photo_path)
                                        <img class="w-7 h-7 rounded-full mr-3"
                                            src="{{ config('app.url') . Storage::url($post->author->profile_photo_path)}}"
                                        
                                            alt="avatar">
                                    @else
                                        <span class="flex w-7 h-7 rounded-full mr-3 bg-gray-200 text-gray-900 items-center justify-center">
                                            {{ strtoupper($post->author->name[0]) }}
                                        </span>
                                    @endif
